...
const ProjectsSection = () => {
    ...
    return (
        <section id="projects">
            <h2 className="text-center mx-auto w-1/3 text-4xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mt-20 mb-8 md:mb-12">
                My Projects
            </h2>
